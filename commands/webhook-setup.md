...
description: "Shortcut: Generate copy-paste webhook bridge setup guides (Slack, Discord, WhatsApp, Telegram, Email) -> /ll-webhook-setup"
version: 1.0.0
...
Telegram secret-token header, Cloudflare Email Routing). Sibling to
